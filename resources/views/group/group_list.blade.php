                        ...
                        <table class="table table-bordered">
                            ...
                            <tbody>
                                ...
                                <tr>
                                    ...
                                    <td>
                                        <a href="{{ URL::to('attendence-group-details/'.$row->id) }}" class="badge badge-pill bg-primary">
                                        ...
                                        <a href="{{ URL::to('get-application-by-group/'.$row->id) }}" class="badge badge-pill bg-warning">
