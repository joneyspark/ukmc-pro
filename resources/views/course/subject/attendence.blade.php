            ...
            <div class="col-3 mt-3">
                <div class="card style-2 mb-md-0 mb-4">
                    ...
                    <div class="text-center">
                        <img src="https://bheuni.io/front/img/teams/tanvir.png" class="card-img-top rounded-circle" alt="..." style="width: 180px">
                    </div>
                    <h4 class="text-center pt-3">Tanvir Nawaz Khan</h4>
                    <p class="text-center">BHE-354322</p>
