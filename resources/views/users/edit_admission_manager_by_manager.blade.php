...
@section('admin')
    <div class="layout-px-spacing">
        <div class="middle-content container-xxl p-0">
            ...
            <form method="post" action="{{ URL::to('edit-admission-manager-by-manager-post') }}" enctype="multipart/form-data">
                @csrf
                            ...
                            <div class="row mb-4">
                                <div class="col-xl-12 col-md-12 col-sm-12 col-12">
                                    <div class="d-flex align-items-start justify-content-between">
                                        <h4>Officer Information</h4><a href="{{ URL::to('my-team-list') }}" class="btn btn-info btn-rounded mb-2 mr-4 inline-flex items-center"> My Team
